/* Scoreboard loader (JS-only). No CSS/HTML changes. JSON-first to avoid kpis.csv 404s. */
(function(){
  'use strict';

  // Existing IDs/classes expected on the page:
  // myTeamRow, kpiToday, kpiWeek, kpiSeason, liveVotes, movers, standingsBody, feed
  ...
  async function init(){
    ...
    // JSON-first to avoid CSV 404 noise
